...
type ChannelOtherSettings struct {
	...
	OpenRouterFreeAlphaSyncEnabled               bool              `json:"openrouter_auto_sync_free_and_alpha_models_enabled,omitempty"` // OpenRouter 是否自动维护免费及 Alpha 测试模型（以 -alpha 结尾，不限提供商）
